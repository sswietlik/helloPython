...
print('----------cos tu nie dziala -------------------------')

wordDictionary = {} #W tym dictionary kluczem będzie słowo z tekstu a wartością ilość wystąpień słowa w tekście
listOfWords = text.split(' ')
for eachWord in listOfWords:
    if eachWord in wordDictionary.keys():
